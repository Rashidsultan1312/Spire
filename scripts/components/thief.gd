...
func jump_to(target_pos: Vector2) -> Tween:
	...
	sq_tw.tween_property(body, "scale", Vector2(6.5, 3.5), 0.08)
	sq_tw.tween_property(body, "scale", Vector2(4, 6.5), 0.15)
	sq_tw.tween_property(body, "scale", Vector2(5, 5), 0.15)
	...
	tw.tween_property(body, "scale", Vector2(6.5, 3.5), 0.06)
	tw.tween_property(body, "scale", Vector2(5, 5), 0.1)
...
func victory_bounce():
	var tw := create_tween()
	tw.tween_property(body, "scale", Vector2(6.5, 3.5), 0.1)
	tw.tween_property(body, "scale", Vector2(4, 7), 0.15).set_trans(Tween.TRANS_BACK)
	tw.tween_property(body, "scale", Vector2(5, 5), 0.12)
